        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Promotions_DATE", "StartDate < EndDate");
                    table.CheckConstraint("CK_Promotions_TYPE", "DiscountType IN ('percent', 'fixed')");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Users_ROLE", "Role IN ('buyer', 'seller', 'admin')");
                });
           ...
           columns: table => new
           {
               ...
               FinalPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false, computedColumnSql: "[TotalPrice] - [DiscountAmount]", stored: true),
           ...
           constraints: table =>
           {
               ...
               table.CheckConstraint("CK_Orders_DISCOUNT", "DiscountAmount >= 0");
               table.CheckConstraint("CK_Orders_PRICE", "TotalPrice >= 0");
               table.CheckConstraint("CK_Orders_STATUS", "Status IN ('pending', 'paid', 'processing', 'shipped', 'delivered', 'cancelled', 'refunded')");
               table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Products_PRICE", "BasePrice >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Country = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, defaultValue: "Россия"),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Shipping_METHOD", "ShippingMethod IN ('courier', 'pickup', 'post', 'express')");
                    table.CheckConstraint("CK_Shipping_STATUS", "Status IN ('pending', 'processing', 'shipped', 'delivered', 'returned')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Carts_ProductSkus_ProductSkuId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PriceHistory_ProductSkus_SkuId",
                        column: x => x.SkuId,
                        principalTable: "ProductSkus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PriceHistory_Users_ChangedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductImages_ProductSkus_SkuId",
                        column: x => x.SkuId,
                        principalTable: "ProductSkus",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceHistory_ChangedBy",
                table: "PriceHistory",
                column: "ChangedBy");

            migrationBuilder.CreateIndex(
                name: "IX_PriceHistory_SkuId",
                table: "PriceHistory",
                column: "SkuId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sellers_VERIFIED",
                table: "Sellers",
                column: "Verified");

            migrationBuilder.CreateIndex(
                name: "UQ_SELLER_STORE",
                table: "Sellers",
                column: "StoreName",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shipping_TRACKING",
                table: "Shipping",
                column: "TrackingNumber");

            migrationBuilder.CreateIndex(
                name: "UQ_Shipping_ORDER",
                table: "Shipping",
                column: "OrderId",
                unique: true);
